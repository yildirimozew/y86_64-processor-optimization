...
long long gen_f_pc()
{
    return ((((ex_mem_curr->icode) == (I_JMP)) & !(ex_mem_curr->takebranch)
      ...
      (mem_wb_curr->valm) : ((mem_wb_curr->icode) == (I_JTAB)) ? 
...
long long gen_F_stall()
{
    return (((((id_ex_curr->icode) == (I_MRMOVQ) || (id_ex_curr->icode) == 
            ...
            (id_ex_curr->destm) == (id_ex_next->srcb))) | ((I_JTAB) == 
          (if_id_curr->icode) || (I_JTAB) == (id_ex_curr->icode) || 
          (I_JTAB) == (ex_mem_curr->icode))) | ((I_RET) == 
