...
# I added the jtab instruction functioning similar to the ret instruction and processed(inserting stalls and bubbles) similar to the return processing.
#/* $begin pipe-all-hcl */
####################################################################
...
bool E_bubble =
	...
	(E_icode == IJXX && !e_Cnd) ||
	# Conditions for a load/use hazard
	E_icode in { IMRMOVQ, IPOPQ, IJTAB } &&
	 E_dstM in { d_srcA, d_srcB};
